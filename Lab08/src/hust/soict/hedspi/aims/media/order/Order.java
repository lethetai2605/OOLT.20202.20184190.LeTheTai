package hust.soict.hedspi.aims.media.order;
...
//        if(k == 1){
//            System.out.printf("the dvd "+hust.soict.hedspi.aims.media.getTitle()+" could not be added.");
...
//            hust.soict.hedspi.aims.media.setId(0);
//            hust.soict.hedspi.aims.media.setCost(0);
//            hust.soict.hedspi.aims.media.setTitle(null);
//            hust.soict.hedspi.aims.media.setCategory(null);
