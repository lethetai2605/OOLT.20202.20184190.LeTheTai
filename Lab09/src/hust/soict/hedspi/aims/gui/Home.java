...
public class Home extends JFrame {
	...
	protected JButton removeButton = new JButton("Delete item by id");
	protected JButton displayButton =  new JButton("Display the items list of order");
...
//							listOrder.get(locationOrder).setTotalCost();
			...
			//setup OK button
					...
					JOptionPane.showMessageDialog(null,"Phai tao order");
					return;
				}
	...
	private void createButtonSetting() {
		...
		createButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {				
				...
				listOrder.add(order);
				JOptionPane.showMessageDialog(null, "Da khoi tao Order", "Order", JOptionPane.INFORMATION_MESSAGE);
			}
		});
