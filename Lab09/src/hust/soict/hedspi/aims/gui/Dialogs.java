...
public class Dialogs extends JDialog{
	...
	private Float getCost() throws Exception{
		...
		try {
			...
			if (cost <= 0) throw new InputException("Cost phai >= 0");
		} catch (Exception e) {
			throw new InputException("Cost phai la 1 so");
		}
		return cost;
	}
	...
	public boolean isEmpty() throws Exception{
		if(titleField.getText().equals("") || idField.getText().equals("") || 
			...
			throw new InputException("Chua nhap day du thong tin ");
		}
		else return false;
	}
		...
		bookDialog.okJButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					order.addMedia(book);
					JOptionPane.showMessageDialog(null, "Them thanh cong book ", "Book", JOptionPane.INFORMATION_MESSAGE);
...
//		CD.add(noteJLabel);
	...
	public void removeDialog(ArrayList<Order> listOrder) {
		...
		JLabel rmLabelItem = new JLabel("Item id");
